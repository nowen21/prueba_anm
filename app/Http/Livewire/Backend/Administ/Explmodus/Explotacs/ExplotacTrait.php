...
namespace App\Http\Livewire\Backend\Administ\Explmodus\Explotacs;
...
trait ExplotacTrait
{
    ...
    public $tipomine;
    public $accionxx;
    public $compleme = 'explmodus.explotacs';
    function mountExplotac(): void
    {
        $this->volverxx = $this->permisox . '-listaxxx';
        $this->accionxx = 'Explotación';
        $this->moduloxx = 'explotac';
        $this->permisox = 'explotac';
        $this->titumodu = 'Módulo Explotaciones';
        $this->pestania = ['moduloxx' => 'explmodu', 'pestania' => $this->permisox];
    }
    public function buscarExplotac($modeloid,$vistaxxx=false)
    {
