...
namespace App\Http\Livewire\Backend\Administ\Perfmodus\Perfils\Edit;

use App\Http\Livewire\Backend\Administ\Perfmodus\Perfils\PerfilTrait;
...
class PerfilEditLivewire extends Component
{
    use CrudTrait, PerfilTrait;
    ...
    {
        $this->validate();
        $rolexxxx = Role::find(5);
       
        if ($this->modesele->hasRole($rolexxxx->name)) {
            $this->modesele->estado_id=4;
        }
        $this->modesele->update(
            [
                ...
                'estado_id' => $this->modesele->estado_id,
