...
namespace App\Http\Livewire\Backend\Administ\Comemodus\Aprocomes;
...
trait AprocomeTrait
{
    ...
    public $tipomine;
    public $accionxx;
    public $compleme = 'comemodus.aprocomes';

 
    function mountAprocome(): void
    {
        $this->volverxx = $this->permisox . '-listaxxx';
        $this->accionxx = 'Comercialización';
        $this->moduloxx = 'aprocome';
        $this->permisox = 'aprocome';
        $this->titumodu = 'Módulo Comercialización';
        $this->pestania = ['moduloxx' => 'comemodu', 'pestania' => $this->permisox];
    }
    public function buscarAprocome($modeloid, $vistaxxx = false)
    {
