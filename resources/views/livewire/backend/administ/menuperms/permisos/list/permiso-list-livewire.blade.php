<div>
        ...
        <x-slot name="searchxx">
            <div class="card-tools">
                <div class="input-group input-group-sm">
                    <input type="text" class="form-control" placeholder="Rol" wire:model="search">
    ...
    @break
    @case('create')
    <livewire:backend.administ.menuperms.roles.create.role-create-livewire>
    </livewire:backend.administ.menuperms.roles.create.role-create-livewire>
    @break
    @case('view')
    <livewire:backend.administ.menuperms.roles.view.role-view-livewire :modeloid="$modeloid">
    </livewire:backend.administ.menuperms.roles.view.role-view-livewire>
    @break
    @endswitch
    @push('scriptsl')
