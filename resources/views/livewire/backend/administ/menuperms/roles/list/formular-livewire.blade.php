<table id="example2" class="table table-bordered table-hover">
    <thead>
        <tr>
            ...
            @can('roleperm-listaxxx')
            <th class="col-1">Permisos</th>
            @endcan
    ...
    <tbody>
        ...
        <tr>
            ...
            @can('roleperm-listaxxx')
            <td class="text-end">
            <a href="{{route('roleperm-listaxxx',$item->id)}}" class="btn btn-primary btn-sm"  data-bs-toggle="tooltip" data-bs-placement="top" title="Permisos">
