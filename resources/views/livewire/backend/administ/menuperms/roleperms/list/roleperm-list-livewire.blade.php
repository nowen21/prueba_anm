<div>
    ...
    <x-template.template-component :pestania='$pestania'>
        ...
        <x-slot name="botoadic">
            ...
            @endcan
            <a class="btn btn-info btn-sm" href="{{route('rolexxxx-listaxxx')}}" title="{{__('Volver a Roles')}}">
        ...
        <x-slot name="searchxx">
            <div class="card-tools">
                <div class="input-group input-group-sm">
                    <input type="text" class="form-control" placeholder="Permiso Rol" wire:model="search">
    ...
    @break
    @case('create')
    <livewire:backend.administ.menuperms.roleperms.create.roleperm-create-livewire :modeloid="$modeloid">
    </livewire:backend.administ.menuperms.roleperms.create.roleperm-create-livewire>
    @break
    @case('view')
    <livewire:backend.administ.menuperms.roleperms.view.roleperm-view-livewire :modeloid="$modeloid">
    </livewire:backend.administ.menuperms.roleperms.view.roleperm-view-livewire>
    @break
    @endswitch
    @push('scriptsl')
