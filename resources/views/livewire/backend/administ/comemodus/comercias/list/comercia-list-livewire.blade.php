<div>
    ...
    @break
    @case('create')
    <livewire:backend.administ.comemodus.comercias.create.comercia-create-livewire>
    </livewire:backend.administ.comemodus.comercias.create.comercia-create-livewire>
    @break
    @case('view')
    <livewire:backend.administ.comemodus.comercias.view.comercia-view-livewire :modeloid="$modeloid">
    </livewire:backend.administ.comemodus.comercias.view.comercia-view-livewire>
    @break
    @endswitch
    @push('scriptsl')
