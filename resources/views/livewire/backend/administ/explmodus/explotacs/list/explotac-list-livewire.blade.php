<div>
    ...
    @break
    @case('create')
    <livewire:backend.administ.explmodus.explotacs.create.explotac-create-livewire>
    </livewire:backend.administ.explmodus.explotacs.create.explotac-create-livewire>
    @break
    @case('view')
    <livewire:backend.administ.explmodus.explotacs.view.explotac-view-livewire :modeloid="$modeloid">
    </livewire:backend.administ.explmodus.explotacs.view.explotac-view-livewire>
    @break
    @endswitch
    @push('scriptsl')
