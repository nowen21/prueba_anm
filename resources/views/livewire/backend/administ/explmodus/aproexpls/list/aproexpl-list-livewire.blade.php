<div>
    ...
    @break
    @case('create')
    <livewire:backend.administ.explmodus.aproexpls.create.aproexpl-create-livewire>
    </livewire:backend.administ.explmodus.aproexpls.create.aproexpl-create-livewire>
    @break
    @case('view')
    <livewire:backend.administ.explmodus.aproexpls.view.aproexpl-view-livewire :modeloid="$modeloid">
    </livewire:backend.administ.explmodus.aproexpls.view.aproexpl-view-livewire>
    @break
    @endswitch
    @push('scriptsl')
