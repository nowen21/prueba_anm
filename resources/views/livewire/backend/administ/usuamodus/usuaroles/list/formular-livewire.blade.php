        ...
        <tr>
            ...
            <td class="text-end">
                ...
                @can($permisox.'-elminact')
                    @if($item->id!=1 || $modeloid!=1)
                    <button class="btn btn-danger btn-sm" wire:click="desasignarRol({{$item->id}})" data-bs-toggle="tooltip" data-bs-placement="top" title="Eliminar">
