<div>
    ...
    @break
    @case('create')
    <livewire:backend.administ.usuamodus.usuarios.create.user-create-livewire>
    </livewire:backend.administ.usuamodus.usuarios.create.user-create-livewire>
    @break
    @case('view')
    <livewire:backend.administ.usuamodus.usuarios.view.user-view-livewire :modeloid="$modeloid">
    </livewire:backend.administ.usuamodus.usuarios.view.user-view-livewire>
    @break
    @endswitch
    @push('scriptsl')
